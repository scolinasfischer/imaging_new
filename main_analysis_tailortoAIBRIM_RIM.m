...
mock_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIM/mock/proj";
avsv_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIM/avsv/proj";
sexc_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIM/sexc/proj";

%set path for xlsx files of each condition here: 
mock_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIM/newRIMxls/wt/mock";
avsv_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIM/newRIMxls/wt/avsv";
sexc_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIM/newRIMxls/wt/sexc";
...
%for baseline-adjusted ratios (R0)
    ...
    plotting.R0ploty1avg  = -1; %lower y axis limit for avg traces plots
    plotting.R0ploty2avg  = +3.5; %upper y axis limit for avg traces plots
...
% % baseline and time for 370smovie, 10fps, 30sec
% % baseline,60sON-60sOFF-60sON-60sOFF (or half of this) AIBBBBB
%     moviepars.bstart = 792;%first frame of baseline
...
% baseline and time for 220s movie RIM
    moviepars.bstart = 792;%first frame of baseline
    moviepars.bend = 891; %last frame of baseline
