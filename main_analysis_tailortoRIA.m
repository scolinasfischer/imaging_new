...
mock_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIA/VENT/MOCK VENT";
avsv_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIA/VENT/AVSV VENT";
sexc_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIA/VENT/SEXC VENT";

%set path for xlsx files of each condition here: 
mock_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/wt/mock";
avsv_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/wt/avsv";
sexc_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/wt/sexc";
...
%set path for mat files of each condition here: 
mt_mock_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIApdf1/VENT/MOCK VENT";
mt_avsv_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIApdf1/VENT/AVSV VENT";
mt_sexc_mat_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/matfiles/RIApdf1/VENT/SEXC VENT";

%set path for xlsx files of each condition here: 
mt_mock_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/p1/mock";
mt_avsv_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/p1/avsv";
mt_sexc_xlsx_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAxls/p1/sexc";
...
analysis_output_dir = "/Volumes/groupfolders/DBIO_Barrios_Lab/IMAGING/feb2025_testing/RIA/VENT/newRIAoutput1";
...
%general
 ...
 %set analysis parameters
    ...
    analysis_pars.full_or_halfmovieplots = "full"; %set to full for full movie, half for half movie NB this only used to set plot ylim, not for anything else    
    ...
    analysis_pars.furtheranalysis_ONOFFclassif = false; %perform ON/OFF classification analysis (like for RIM and AIB). 
...
%for baseline-adjusted ratios (R0)
    plotting.R0ploty1  = -2; %lower y axis limit for single traces plots baseline-adjusted ratios
    plotting.R0ploty2  = +2; %upper y axis limit for single traces plots baseline-adjusted ratios
    plotting.R0ploty1avg  = -0.6; %lower y axis limit for avg traces plots
    plotting.R0ploty2avg  = +0.6; %upper y axis limit for avg traces plots
...
% Movie parameters
    ...
    moviepars.ONend = 1188; %last frame of 1st odour ON
    moviepars.OFFend = 1485; %last frame of 1st odour OFF
    moviepars.last10OFF = 792; %in case different from baseline start eg AIB
    moviepars.last10ON = 1089;  %to calculate onLOW neurons R0 
