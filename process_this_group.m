...
function [all_badjratios, badj_avg, SEMbadj, all_normratios, norm_avg, SEMnorm, all_secs, worm_names] = process_this_group(xlsx_dir, analysis_output_dir, genotype, cond, general, analysis_pars, colors, plotting, moviepars)
% Get file list    
