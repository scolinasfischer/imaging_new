...
bLOW:    during baseline period 
    ...
    OUTPUTS:
        propON        - vector containing proportion of neurons ON at each time point in relevant time window
...
or off.If try to run on anything other than normratios,throw warning and exit function
